 ...
 * unrecoverable, and it is the more informative of the two. Same logic
 * applies to `combined`: a 40-question test across the course is a different
 * signal from a 20-question test of one unit.
 */
