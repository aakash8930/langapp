...
export const Route = createFileRoute('/faq')({ component: () => (
  <InfoPage title="FAQ" backTo="/">
    {[
      ...
      ['How does SRS work?', 'FSRS schedules reviews from your confirmed grades so difficult material returns sooner.'],
      ['Can I study offline?', 'Not yet. Lessons, account sync, AI, and review grading currently require a connection.'],
