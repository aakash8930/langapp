...
export const sidebarGroups: SidebarGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'planned', id: 'listening', label: 'Listening', icon: 'headphones' },
      { kind: 'planned', id: 'speaking', label: 'Speaking', icon: 'mic' },
      { kind: 'link', id: 'reading', label: 'Reading', icon: 'languages', to: '/read' },
      { kind: 'planned', id: 'writing', label: 'Writing', icon: 'pen-tool' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'planned', id: 'flashcards', label: 'Flashcards', icon: 'layers' },
