...
const ACTIONS: {
  ...
  { id: 'mock-test', label: 'Mock test', note: 'Test your level', icon: 'graduation-cap', to: '/jlpt-mock-test' },
  { id: 'planner', label: 'Study planner', note: 'Plan your goals', icon: 'calendar', to: '/progress' },
